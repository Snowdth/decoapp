...
// SEPARACIÓN
	...
	methods: {
		...
		changeTotalHeight: function () {
			...
			this.X[0].height += (this.totalHeight - this.lastTotalHeight)/2
			// this.X[1].height += dh
			this.X[1].height += (this.totalHeight - this.lastTotalHeight)/2
			this.Y[0].height += dh
			this.Y[1].height += dh
		...
		changeTotalWidth: function() {
			...
			this.X[1].width += (this.totalWidth - this.lastTotalWidth)/ this.X[1].cantidad
			this.X[2].width += dh
